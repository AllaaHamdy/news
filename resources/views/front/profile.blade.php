            ...
            <div class="row">
                <div class="col-12">
                    <div class="post-details-thumb mb-50">
                        <img src="https://api-task1.adminssw.com/{{$single_news->imagePath}}" alt="">
                    </div>
                </div>
            </div>
                ...
                <div class="col-12 col-lg-8 col-xl-7">
                    <div class="post-details-content">
                        ...
                        <div class="blog-content">
                            ...
                            <a href="#" class="post-title mb-2">{{$single_news->titel}}</a>
                            <div class="post-meta d-flex justify-content-between">
                                <span><i class="fa fa-comments-o" aria-hidden="true"></i> 14</span>
                                <span><i class="fa fa-eye" aria-hidden="true"></i> {{$single_news->views_num}}</span>
                        ...
                        <p>{{$single_news->description}}</p>
                            ...
                            <div class="vizew-post-author d-flex align-items-center py-5">
                                <div class="post-author-thumb">
                                    <img src="{{url('/')}}/design/front/img/bg-img/30.jpg" alt="">
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="single-post-area mb-50">
                                            ...
                                            <div class="post-thumbnail">
                                                <img src="{{url('/')}}/design/front/img/bg-img/11.jpg" alt="">
                                    ...
                                    <div class="col-12 col-md-6">
                                        <div class="single-post-area mb-50">
                                            <!-- Post Thumbnail -->
                                            <div class="post-thumbnail">
                                                <img src="{{url('/')}}/design/front/img/bg-img/12.jpg" alt="">
                                ...
                                <ul>
                                    ...
                                    <li class="single_comment_area">
                                        ...
                                        <div class="comment-content d-flex">
                                            ...
                                            <div class="comment-author">
                                                <img src="{{url('/')}}/design/front/img/bg-img/31.jpg" alt="author">
                                            </div>
                                            <!-- Comment Meta -->
                                        ...
                                        <ol class="children">
                                            <li class="single_comment_area">
                                                ...
                                                <div class="comment-content d-flex">
                                                    <!-- Comment Author -->
                                                    <div class="comment-author">
                                                        <img src="{{url('/')}}/design/front/img/bg-img/32.jpg" alt="author">
                                                    </div>
                                                    <!-- Comment Meta -->
                                                    <div class="comment-meta">
                                                        <a href="#" class="comment-date">27 Aug 2019</a>
                                    ...
                                    <li class="single_comment_area">
                                        ...
                                        <div class="comment-content d-flex">
                                            <!-- Comment Author -->
                                            <div class="comment-author">
                                                <img src="{{url('/')}}/design/front/img/bg-img/33.jpg" alt="author">
                                            </div>
                                            <!-- Comment Meta -->
                                            <div class="comment-meta">
                                                <a href="#" class="comment-date">27 Aug 2019</a>
                ...
                <div class="col-12 col-md-6 col-lg-4 col-xl-3">
                    <div class="sidebar-area">
                        ...
                        <div class="single-widget p-0 author-widget">
                            <div class="p-4">
                                <img class="author-avatar" src="{{url('/')}}/design/front/img/bg-img/30.jpg" alt="">
            ...
            <div class="row">
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="footer-widget mb-70">
                        <!-- Logo -->
                        <a href="index.html" class="foo-logo d-block mb-4"><img src="{{url('/')}}/design/front/img/core-img/logo2.png" alt=""></a>
                ...
                <div class="col-12 col-sm-6 col-xl-3">
                    <div class="footer-widget mb-70">
                        ...
                        <div class="single-blog-post d-flex">
                            <div class="post-thumbnail">
                                <img src="{{url('/')}}/design/front/img/bg-img/1.jpg" alt="">
                            </div>
                            <div class="post-content">
                        ...
                        <div class="single-blog-post d-flex">
                            <div class="post-thumbnail">
                                <img src="{{url('/')}}/design/front/img/bg-img/2.jpg" alt="">
                            </div>
                            <div class="post-content">
